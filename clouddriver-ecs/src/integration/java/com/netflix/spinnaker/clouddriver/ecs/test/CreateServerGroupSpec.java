...
public class CreateServerGroupSpec extends EcsSpec {
  ...
  @DisplayName(
      ".\n===\n"
          ...
          + "\n===")
  @Test
  public void createServerGroup_InputsEc2LegacyTargetGroupTestWithoutLoadBalacing()
      throws IOException, InterruptedException {
  ...
  @DisplayName(
      ".\n===\n"
          + "Given description w/ inputs, EC2 launch type, legacy target group "
          + "and service discovery registry fields, "
          + "successfully submit createServerGroup operation"
          + "\n===")
  @Test
  public void createServerGroup_InputsEc2LegacyTargetGroupServiceDiscoveryTest()
      throws IOException, InterruptedException {
